 ...
 * @version 1.7
 * 
 * @note I've added antialiasing and instance for action. These make easier to use this class.
 */
public class Fenetre implements ActionListener {
	...
	private Map<String, Image> imagesParChemin = new HashMap<String, Image>();
	...
	/**
	 * Dessine une image à la position spécifiée une fois la fonction
	 * {@link #afficher} exécutée.
	 * 
	 * @param cheminImage le chemin d'accès à l'image (par exemple : "img\logo.png")
	 ...
	 * @since 1.0
	 */
	public void dessinerImage(String cheminImage, int x, int y) {
		panneau.dessinerImage(getImage(cheminImage), new Position(y, x));
	}
	...
	/**
	 * Affiche tous les dessins effectués préalablement à l'aide de la fonction.
	 * 
	 * @since 1.0
	 */
	...
	/**
	 * Dessine un rectangle noir selon la position, la largeur et la hauteur
	 * spécifiées.
	 * 
	...
	/**
	 * Dessine un rectangle selon la couleur, la position, la largeur et la hauteur
	 * spécifiées.
	 * 
	...
	/**
	 * Dessine un oval noir selon la position, la largeur et la hauteur spécifiées.
	 * 
	 * @param x       la coordonnée x de l'angle supérieur gauche du rectangle
	 * @param y       la coordonnée y de l'angle supérieur gauche du rectangle
	 * @param largeur la largeur du rectangle
	 ...
	 * @since 1.7
	 */
	public void dessinerOval(int x, int y, int largeur, int hauteur) {
		panneau.dessinerOval(Color.BLACK, new Position(y, x), largeur, hauteur);
	}

	/**
	 * Dessine un oval selon la couleur, la position, la largeur et la hauteur
	 * spécifiées.
	 * 
	 * @param couleur la couleur du rectangle
	 * @param x       la coordonnée x de l'angle supérieur gauche du rectangle
	 ...
	 * @since 1.7
	 */
	public void dessinerOval(Color couleur, int x, int y, int largeur, int hauteur) {
		panneau.dessinerOval(couleur, new Position(y, x), largeur, hauteur);
	}
	...
	private class Panneau extends JPanel {
		...
		public void dessinerImage(Image image, Position position) {
			graphics.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
			graphics.drawImage(image, position.j, position.i, this);
		}

		public void dessinerImage(Image image, Position position, Dimension dimensions) {
			graphics.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
			graphics.drawImage(image, position.j, position.i, dimensions.width, dimensions.height, this);
		}

		public void dessinerLigne(Color couleur, Position p1, Position p2) {
			graphics.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
			graphics.setColor(couleur);
			graphics.drawLine(p1.j, p1.i, p2.j, p2.i);
		}

		public void dessinerRectangle(Color couleur, Position p, int largeur, int hauteur) {
			graphics.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
			graphics.setColor(couleur);
			graphics.fillRect(p.j, p.i, largeur, hauteur);
		}

		public void dessinerOval(Color couleur, Position p, int largeur, int hauteur) {
			graphics.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
			graphics.setColor(couleur);
			graphics.fillOval(p.j, p.i, largeur, hauteur);
		}
